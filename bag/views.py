    ...
    if size:
        if item_id in list(bag.keys()):
            if size in bag[item_id]['items_by_size'].keys():
                ...
                bag[item_id]['items_by_size'][size] = quantity
                messages.success(request, f'Added size {size.uppper()} {product.name} quantity to {bag[item_id]['items_by_size'][size]}')
        else:
            bag[item_id] = {'items_by_size': {size: quantity}}
            messages.success(request, f'Added size {size.uppper()} {product.name} to your bag')
    else:
        if item_id in list(bag.keys()):
